...
public class CharsetTrun {
	...
	public static void main(String[] args) {
		...
		String source ="µçÄÔµñ¿Ì¡¤Ê¦¸µ£¬4Äê¾­Ñé===–|½zGƒÉ‡À†Êrg23g";
	...
	public static String GB2312ToBIG5Str(String str)
	{
		...
		{
			if(str.charAt(i)=='¡¤'){//ÓÉÓÚ¡¤ÔÚÓÊ¼þ¿Í»§¶ËÊÇÂÒÂë£¬ËùÒÔÕâÀïÃæ»»³ÉÓ¢ÎÄµãºÅ xurun 2006-10-6
			    restr+=".";
			}else{
